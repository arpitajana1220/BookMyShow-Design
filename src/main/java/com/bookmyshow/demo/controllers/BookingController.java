...
public class BookingController {
    ...
    private static final String USER_VALID = "Something went wrong";
    ...
    public BookShowResponseDto bookShow(BookShowRequestDto request){
        ...
        try {
            ...
            return new BookShowResponseDto(booking.getId(), booking.getAmount(), ResponseStatus.SUCCESS, USER_VALID);
